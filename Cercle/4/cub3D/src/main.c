...
/*   Updated: 2024/04/13 17:03:44 by macbookpro       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// //         || data->map[(int)((x + 10) / PIXEL_SIZE)][(int)((y
// 			// + 10)/ PIXEL_SIZE)] == 1)
// //         return (true);
// //     return (false);
// // }
...
// //     return (pix);
// // }
// // function that takes the touch of the keyboard (key_up, key_down, key_left,
// 	// key_right, esc) and make a player symbolizes by a pixel move
...
// //     while (i < 50)
// //     {
// // //         // mlx_pixel_put(data->mlx, data->win, data->px + i
// 	* cos(data->pa)
// // 	// + 5, data->py + i * sin(data->pa) + 5, color);
// // //         put_pxl_to_img(data, data->px + i * cos(data->pa) + 5, data->py
// 	+ i
// 	// * sin(data->pa) + 5, color);
// //         i++;
// //     }
...
// //             // mlx_pixel_put(data->mlx, data->win, pix.x + i, pix.y + j,
// 	// pix.color);
// //             j++;
// //         }
// //         i++;
...
// //             else
// //                 color = 0x00000000;
// //             pixel_drawing(data, pixel(x * PIXEL_SIZE, y * PIXEL_SIZE,
// 		// PIXEL_SIZE, color));
// //             y++;
// //         }
// //         x++;
...
// //         if (wall->lineOff + j >= 0)
// //         {
// //                 int color = data->texture->texture[(int)wall->tx + 64
// 	* (int)wall->ty];
// //                 put_pxl_to_img(data, 530 + rayH->r, wall->lineOff + j,
// 	color);
// //         }
