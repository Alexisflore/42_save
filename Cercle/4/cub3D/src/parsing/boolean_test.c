...
/*   Updated: 2024/04/13 17:31:27 by macbookpro       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (path->textures->west != NULL && path->textures->east != NULL
		&& path->textures->north != NULL && path->textures->south != NULL
		&& path->floor != NULL && path->ceiling != NULL)
		return (1);
	return (0);
}
